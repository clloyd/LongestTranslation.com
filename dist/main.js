...
(".translationlist__item,ol,ul{list-style:none}.translation{display:inline-block;position:relative;width:calc(100% - 150px)}.translation__bar{height:100%;position:absolute;top:0;left:0;background-color:rgba(64,179,64,.31)}.translationlist__item:nth-child(odd) .translation__bar{background-color:rgba(64,179,64,.4)}.translation__value{position:relative;padding:5px}.language{display:inline-block;width:150px;padding:5px}.translationlist__item:nth-child(odd) .language{background-color:#F3F3F3}.translationlist{margin-top:20px}a,abbr,acronym,address,applet,article,aside,audio,b,big,blockquote,body,canvas,caption,center,cite,code,dd,del,details,dfn,div,dl,dt,em,embed,fieldset,figcaption,figure,footer,form,h1,h2,h3,h4,h5,h6,header,hgroup,html,i,iframe,img,ins,kbd,label,legend,li,mark,menu,nav,object,ol,output,p,pre,q,ruby,s,samp,section,small,span,strike,strong,sub,summary,sup,table,tbody,td,tfoot,th,thead,time,tr,tt,u,ul,var,video{margin:0;padding:0;border:0;font:inherit;vertical-align:baseline}article,aside,details,figcaption,figure,footer,header,hgroup,menu,nav,section{display:block}body{line-height:1;background-color:#f3f3f3;font-family:'Open Sans',sans-serif;font-size:13px}blockquote,q{quotes:none}blockquote:after,blockquote:before,q:after,q:before{content:'';content:none}table{border-collapse:collapse;border-spacing:0}*{box-sizing:border-box}.main{max-width:1000px;margin:0 auto;background-color:#FFF;padding:20px}.main__title{margin-bottom:10px}.form{position:relative}.form__input{height:50px;width:100%;padding:10px;border:1px solid #D8D8D8;border-radius:3px;font-size:20px}.form__input:focus{outline:#A9A9A9 solid 1px}.form__submit{position:absolute;top:6px;right:7px;padding:8px;border:1px solid green;border-radius:3px;background-color:#fff;font-size:16px;color:green}");
});