...
System.register("countries.json!github:systemjs/plugin-json@0.1.0", [], true, function(require, exports, module) {
  var global = System.global,
      __define = global.define;
  global.define = undefined;
  module.exports = {
...
System.register('app/components/translation', ['npm:babel-runtime@5.1.11/helpers/inherits', 'npm:babel-runtime@5.1.11/helpers/create-class', 'npm:babel-runtime@5.1.11/helpers/class-call-check', 'npm:react@0.13.2', 'app/components/translation.css!github:systemjs/plugin-css@0.1.10'], function (_export) {
  ...
  return {
    ...
    execute: function () {
      ...
      Translation = (function (_React$Component) {
...
System.register('app/stores/translations', ['npm:babel-runtime@5.1.11/core-js/object/keys', 'npm:reflux@0.2.7', 'app/actions/fetchTranslations', 'npm:superagent@1.2.0', 'countries.json!github:systemjs/plugin-json@0.1.0'], function (_export) {
  var _Object$keys, Reflux, fetchTranslations, SuperAgent, enabledLanguages;

  return {
    setters: [function (_npmBabelRuntime5111CoreJsObjectKeys) {
      _Object$keys = _npmBabelRuntime5111CoreJsObjectKeys['default'];
    }, function (_npmReflux027) {
      Reflux = _npmReflux027['default'];
    ...
    }, function (_countriesJsonGithubSystemjsPluginJson010) {
      enabledLanguages = _countriesJsonGithubSystemjsPluginJson010['default'];
    }],
    execute: function () {
      'use strict';
      ...
      _export('default', Reflux.createStore({
        ...
        newTranslation: function newTranslation(textToTranslate) {
          var _this = this;
        ...
        fetchTranslation: function fetchTranslation(lang, textToTranslate) {
          var _this2 = this;

          SuperAgent.get('/translate').query({ text: textToTranslate }).query({ lang: lang.code }).end(function (err, resp) {
            if (err) {
              console.log(err);
              return;
            }

            var translation = resp.body.text[0];

            if (translation !== '' && _this2.textToTranslate === textToTranslate) {
              _this2.translations.push({ name: lang.name, value: translation });
              _this2.output();
            }
          });
        },
...
System.register('app/components/translationlist', ['npm:babel-runtime@5.1.11/helpers/inherits', 'npm:babel-runtime@5.1.11/helpers/get', 'npm:babel-runtime@5.1.11/helpers/create-class', 'npm:babel-runtime@5.1.11/helpers/class-call-check', 'npm:react@0.13.2', 'app/components/translation', 'app/stores/translations', 'app/components/translationlist.css!github:systemjs/plugin-css@0.1.10'], function (_export) {
  ...
  return {
    setters: [function (_npmBabelRuntime5111HelpersInherits) {
      ...
      React = _npmReact0132['default'];
    }, function (_appComponentsTranslation) {
    ...
    execute: function () {
      ...
      compareLength = function compare(a, b) {
      ...
      TranslationList = (function (_React$Component) {
        function TranslationList(props) {
          var _this = this;

          _classCallCheck(this, TranslationList);

          _get(Object.getPrototypeOf(TranslationList.prototype), 'constructor', this).call(this, props);

          this.state = { translations: [] };

          TranslationsStore.listen(function (translations) {
            _this.setState({ translations: translations });
          });
        }

        _inherits(TranslationList, _React$Component);

        _createClass(TranslationList, [{
          key: 'render',
          value: function render() {
      ...
      _export('default', TranslationList);
    }
  };
});
System.register('app/main', ['npm:babel-runtime@5.1.11/helpers/inherits', 'npm:babel-runtime@5.1.11/helpers/get', 'npm:babel-runtime@5.1.11/helpers/create-class', 'npm:babel-runtime@5.1.11/helpers/class-call-check', 'npm:react@0.13.2', 'app/components/translationlist', 'app/actions/fetchTranslations', 'app/main.css!github:systemjs/plugin-css@0.1.10'], function (_export) {
  ...
  return {
    setters: [function (_npmBabelRuntime5111HelpersInherits) {
      ...
      React = _npmReact0132['default'];
    }, function (_appComponentsTranslationlist) {
...
(".translationlist__item,ol,ul{list-style:none}.translation{display:inline-block;position:relative;width:calc(100% - 150px)}.translation__bar{position:absolute;top:0;left:0;height:100%;background-color:rgba(64,179,64,.31)}.translationlist__item:nth-child(odd) .translation__bar{background-color:rgba(64,179,64,.4)}.translation__value{position:relative;padding:5px}.language{display:inline-block;width:150px;padding:5px}.translationlist__item:nth-child(odd) .language{background-color:#F3F3F3}.translationlist{margin-top:20px}a,abbr,acronym,address,applet,article,aside,audio,b,big,blockquote,body,canvas,caption,center,cite,code,dd,del,details,dfn,div,dl,dt,em,embed,fieldset,figcaption,figure,footer,form,h1,h2,h3,h4,h5,h6,header,hgroup,html,i,iframe,img,ins,kbd,label,legend,li,mark,menu,nav,object,ol,output,p,pre,q,ruby,s,samp,section,small,span,strike,strong,sub,summary,sup,table,tbody,td,tfoot,th,thead,time,tr,tt,u,ul,var,video{margin:0;padding:0;border:0;font:inherit;vertical-align:baseline}article,aside,details,figcaption,figure,footer,header,hgroup,menu,nav,section{display:block}body{line-height:1;background-color:#f3f3f3;font-family:'Open Sans',sans-serif;font-size:13px}blockquote,q{quotes:none}blockquote:after,blockquote:before,q:after,q:before{content:'';content:none}table{border-collapse:collapse;border-spacing:0}*{box-sizing:border-box}.main{max-width:1000px;margin:0 auto;background-color:#FFF;padding:20px}.main__title{margin-bottom:10px}.form{position:relative}.form__input{height:50px;width:100%;padding:10px;border:1px solid #D8D8D8;border-radius:3px;font-size:20px}.form__input:focus{outline:#A9A9A9 solid 1px}.form__submit{position:absolute;top:6px;right:7px;padding:8px;border:1px solid green;border-radius:3px;background-color:#fff;font-size:16px;color:green}");
});